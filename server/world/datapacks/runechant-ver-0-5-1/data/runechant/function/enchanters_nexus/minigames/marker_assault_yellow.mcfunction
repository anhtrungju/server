...
particle minecraft:dust_color_transition{from_color:[1f,0.68f,0f],scale:1f,to_color:[0f,0f,0f]} ~ ~1 ~ 0 0 0 0 1
...
execute if score @s GuardianAssault matches 300.. run summon minecraft:husk ~ ~ ~ {DeathLootTable:"runechant:drops/special/nexus_assault",Health:12,attributes:[{id:"generic.follow_range",base:16f},{id:"generic.max_health",base:12f}]}
