tellraw @a[distance=..12] [{"selector":"@s","interpret":true},{"text":" uses "},{"text":"[Soul Fragment]","color":"yellow","hoverEvent":{"action":"show_text","value":{"text":"A fragment of the Wither Skeleton's soul lingers."}}}]
playsound minecraft:entity.skeleton.hurt hostile @a ~ ~ ~
particle minecraft:sculk_soul ~ ~1 ~ 0 0 0 0.01 10
