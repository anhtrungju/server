tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" uses "},{"text":"[Web Shot]","color":"yellow","hoverEvent":{"action":"show_text","value":{"text":"Ara webs a nearby entity as food for her young."}}}]
...
summon minecraft:spider ~ ~ ~ {Tags:[tElite,Brood]}
summon minecraft:spider ~ ~ ~ {Tags:[tElite,Brood]}
