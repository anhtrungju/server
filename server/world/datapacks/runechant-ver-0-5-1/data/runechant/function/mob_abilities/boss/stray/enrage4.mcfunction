tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" uses "},{"text":"[Dark Power]","color":"red","hoverEvent":{"action":"show_text","value":{"text":"The Nightmare King's power lingers."}}}]
