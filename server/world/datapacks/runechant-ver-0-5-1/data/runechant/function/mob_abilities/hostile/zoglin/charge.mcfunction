tellraw @a[distance=..8] [{"selector":"@s","interpret":true},{"text":" uses "},{"text":"[Charge]","color":"yellow","hoverEvent":{"action":"show_text","value":{"text":"The Zoglin charges forward."}}}]
playsound minecraft:entity.zoglin.attack hostile @a ~ ~ ~
