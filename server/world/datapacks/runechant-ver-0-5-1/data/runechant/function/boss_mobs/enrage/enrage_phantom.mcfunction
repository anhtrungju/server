tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" grows in power now that it's master's control has been broken"}]
...
data modify entity @s DeathLootTable set value "runechant:need_to_make/boss_drops/enraged/phantom"
