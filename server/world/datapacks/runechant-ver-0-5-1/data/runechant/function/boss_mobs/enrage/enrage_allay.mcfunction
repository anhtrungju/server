tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" grows impatient"}]
...
data modify entity @s DeathLootTable set value "runechant:need_to_make/boss_drops/enraged/allay"
