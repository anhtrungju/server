tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" begins to rampage without it's master's control"}]
...
data modify entity @s DeathLootTable set value "runechant:need_to_make/boss_drops/enraged/golem"
