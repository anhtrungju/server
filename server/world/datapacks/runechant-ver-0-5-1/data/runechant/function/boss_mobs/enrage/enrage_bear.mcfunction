tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" unleashes it's power at the loss of it's master."}]
...
data modify entity @s DeathLootTable set value "runechant:need_to_make/boss_drops/enraged/bear"
