tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" remembers the teachings of the first."}]
...
data modify entity @s DeathLootTable set value "runechant:need_to_make/boss_drops/enraged/rcmagic"
