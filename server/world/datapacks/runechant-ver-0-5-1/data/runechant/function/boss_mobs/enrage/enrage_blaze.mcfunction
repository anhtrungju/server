tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" rages as it's fire gorws hotter."}]
...
data modify entity @s DeathLootTable set value "runechant:need_to_make/boss_drops/enraged/blaze"
