tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" siphons the remaining energy from it\'s steed as it dies"}]
...
data modify entity @s DeathLootTable set value "runechant:need_to_make/boss_drops/enraged/stray"
