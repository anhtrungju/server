tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" becomes oddly calmer watching it's creation be destroyed"}]
...
data modify entity @s DeathLootTable set value "runechant:need_to_make/boss_drops/enraged/trader"
