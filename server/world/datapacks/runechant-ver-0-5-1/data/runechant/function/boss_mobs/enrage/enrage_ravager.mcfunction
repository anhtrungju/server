tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" regains it's strength now that it's burden has been lifted."}]
...
data modify entity @s DeathLootTable set value "runechant:need_to_make/boss_drops/enraged/ravager"
