tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" enters a frenzy at the sight of so much gold"}]
...
data modify entity @s DeathLootTable set value "runechant:need_to_make/boss_drops/enraged/piglin"
