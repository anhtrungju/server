tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" becomes empowered by it's acolytes"}]
...
data modify entity @s DeathLootTable set value "runechant:need_to_make/boss_drops/enraged/rc"
