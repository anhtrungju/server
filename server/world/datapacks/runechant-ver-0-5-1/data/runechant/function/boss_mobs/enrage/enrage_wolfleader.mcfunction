tellraw @a[distance=..16] [{"selector":"@s","interpret":true},{"text":" becomes enraged at the loss of it's cub."}]
...
data modify entity @s DeathLootTable set value "runechant:need_to_make/boss_drops/enraged/wolfleader"
