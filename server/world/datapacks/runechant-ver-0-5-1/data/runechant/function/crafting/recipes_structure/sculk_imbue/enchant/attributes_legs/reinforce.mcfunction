...
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.armor",amount:0.05,operation:"add_multiplied_total",slot:"legs","id":"generic.armor",UUID:[I;-1997,1997,4101,-1]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.movement_speed",amount:-0.05,operation:"add_multiplied_total",slot:"legs","id":"generic.movement_speed",UUID:[I;-1997,1997,41016,-2]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.attack_speed",amount:-0.05,operation:"add_multiplied_total",slot:"legs","id":"generic.attack_speed",UUID:[I;-1997,1997,41016,-3]}