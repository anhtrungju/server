...
data modify storage runechant_crafting_polished_basalt runechant set from entity @s
data modify storage runechant_crafting_polished_basalt1 runechant set from entity @e[type=minecraft:item,distance=0.01..1,sort=random,limit=1]
data modify storage runechant_crafting_polished_basalt2 runechant set from entity @e[type=minecraft:item,distance=0.01..1,sort=random,limit=1]
data modify storage runechant_crafting_polished_basalt3 runechant set from entity @e[type=minecraft:item,distance=0.01..1,sort=random,limit=1]
data modify storage runechant_crafting_polished_basalt4 runechant set from entity @e[type=minecraft:item,distance=0.01..1,sort=random,limit=1]


execute if data storage minecraft:runechant_crafting_polished_basalt {runechant:{Item:{id:"minecraft:netherite_scrap",count:1,components:{}}}} run function runechant:crafting/recipes_structure/polished_basalt/template_check

data remove storage minecraft:runechant_crafting_polished_basalt runechant
data remove storage minecraft:runechant_crafting_polished_basalt1 runechant
data remove storage minecraft:runechant_crafting_polished_basalt2 runechant
data remove storage minecraft:runechant_crafting_polished_basalt3 runechant
data remove storage minecraft:runechant_crafting_polished_basalt4 runechant