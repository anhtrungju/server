...
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.max_absorption",amount:0.05,operation:"add_multiplied_total",slot:"chest","id":"generic.max_absorption"}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.max_health",amount:-0.05,operation:"add_multiplied_total",slot:"chest","id":"generic.max_health"}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.attack_damage",amount:-0.05,operation:"add_multiplied_total",slot:"chest","id":"generic.attack_damage"}