...
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.knockback_resistance",amount:0.05,operation:"add_multiplied_total",slot:"legs","id":"generic.knockback_resistance",UUID:[I;-1997,1997,41017,-1]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.movement_speed",amount:-0.05,operation:"add_multiplied_total",slot:"legs","id":"generic.movement_speed",UUID:[I;-1997,1997,41017,-2]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.max_absorption",amount:-0.05,operation:"add_multiplied_total",slot:"legs","id":"generic.max_absorption",UUID:[I;-1997,1997,41017,-3]}