...
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.movement_speed",amount:0.05,operation:"add_multiplied_total",slot:"head","id":"generic.movement_speed",UUID:[I;-1997,1997,41032,-1]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.armor",amount:-0.05,operation:"add_multiplied_total",slot:"head","id":"generic.armor",UUID:[I;-1997,1997,41032,-2]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.armor_toughness",amount:-0.05,operation:"add_multiplied_total",slot:"head","id":"generic.armor_toughness",UUID:[I;-1997,1997,41032,-3]}