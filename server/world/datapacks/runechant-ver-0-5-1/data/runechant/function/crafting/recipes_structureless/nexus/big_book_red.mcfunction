...
execute if entity @e[type=minecraft:marker,distance=..0.5,tag=GreenFire] run experience add @p 3 levels
...
execute if entity @e[type=minecraft:marker,distance=..0.5,tag=RedFire] run experience add @p 1 levels
