...
execute unless data entity @s {Item:{components:{"minecraft:lore":['{"bold":false,"color":"light_purple","italic":false,"text":"Charm (Ethereal)"}']}}} run data modify entity @s Item.components."minecraft:lore" append value '{"bold":false,"color":"light_purple","italic":false,"text":"Charm (Ethereal)"}'

data remove entity @s Item.components."minecraft:lore"[0]

playsound minecraft:bEthereal.beacon.power_select ambient @a ~ ~ ~
