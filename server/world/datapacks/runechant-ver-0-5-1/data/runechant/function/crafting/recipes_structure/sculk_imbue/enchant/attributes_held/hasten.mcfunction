...
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.attack_speed",amount:0.05,operation:"add_multiplied_total",slot:"mainhand","id":"generic.attack_speed",UUID:[I;-1997,1997,4194,-1]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.armor",amount:-0.05,operation:"add_multiplied_total",slot:"mainhand","id":"generic.armor",UUID:[I;-1997,1997,4194,-2]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.armor_toughness",amount:-0.05,operation:"add_multiplied_total",slot:"mainhand","id":"generic.armor_toughness",UUID:[I;-1997,1997,4194,-3]}