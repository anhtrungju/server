...
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.max_health",amount:0.05,operation:"add_multiplied_total",slot:"feet","id":"generic.max_health",UUID:[I;-1997,1997,41009,-1]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.luck",amount:-0.05,operation:"add_multiplied_total",slot:"feet","id":"generic.luck",UUID:[I;-1997,1997,41009,-2]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.attack_damage",amount:-0.05,operation:"add_multiplied_total",slot:"feet","id":"generic.attack_damage",UUID:[I;-1997,1997,41009,-3]}