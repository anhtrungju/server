execute if block ~ ~ ~ minecraft:air run tag @s add Built

execute if entity @s[tag=Built] align x align y align z run function runechant:crafting/multiblock_structures/structure_kits/xp_infuser
