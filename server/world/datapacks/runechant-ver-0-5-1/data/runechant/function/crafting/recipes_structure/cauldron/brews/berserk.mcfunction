data modify entity @s Item.components."minecraft:lore" append value '{"text":"Berserker\'s Brew","color":"green","italic":false,"bold":false}'
data modify entity @s Item.components."minecraft:potion_contents".custom_effects append value {duration:1,amplifier:124b,id:"minecraft:resistance"}
