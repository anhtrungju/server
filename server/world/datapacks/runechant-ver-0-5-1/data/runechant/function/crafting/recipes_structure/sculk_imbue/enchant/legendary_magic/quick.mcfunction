...
execute unless data entity @s {Item:{components:{"minecraft:lore":['{"bold":false,"color":"gold","italic":false,"text":"Quick III"}']}}} run data modify entity @s Item.components."minecraft:lore" append value '{"bold":false,"color":"gold","italic":false,"text":"Quick III"}'
