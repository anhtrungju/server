...
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.attack_damage",amount:0.05,operation:"add_multiplied_total",slot:"legs","id":"generic.attack_damage",UUID:[I;-1997,1997,41015,-1]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.knockback_resistance",amount:-0.05,operation:"add_multiplied_total",slot:"legs","id":"generic.knockback_resistance",UUID:[I;-1997,1997,41015,-2]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.attack_speed",amount:-0.05,operation:"add_multiplied_total",slot:"legs","id":"generic.attack_speed",UUID:[I;-1997,1997,41015,-3]}