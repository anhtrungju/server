...
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.max_absorption",amount:0.05,operation:"add_multiplied_total",slot:"mainhand","id":"generic.max_absorption",UUID:[I;-1997,1997,4191,-1]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.max_health",amount:-0.05,operation:"add_multiplied_total",slot:"mainhand","id":"generic.max_health",UUID:[I;-1997,1997,4191,-2]}
data modify entity @s Item.components."minecraft:attribute_modifiers" append value {type:"generic.attack_damage",amount:-0.05,operation:"add_multiplied_total",slot:"mainhand","id":"generic.attack_damage",UUID:[I;-1997,1997,4191,-3]}