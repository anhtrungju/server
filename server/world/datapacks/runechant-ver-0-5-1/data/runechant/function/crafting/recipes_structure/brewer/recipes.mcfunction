...
data modify storage runechant_crafting_brewer runechant set from entity @s
data modify storage runechant_crafting_brewer1 runechant set from entity @e[type=minecraft:item,distance=0.01..1,sort=random,limit=1]
data modify storage runechant_crafting_brewer2 runechant set from entity @e[type=minecraft:item,distance=0.01..1,sort=random,limit=1]
data modify storage runechant_crafting_brewer3 runechant set from entity @e[type=minecraft:item,distance=0.01..1,sort=random,limit=1]
data modify storage runechant_crafting_brewer4 runechant set from entity @e[type=minecraft:item,distance=0.01..1,sort=random,limit=1]

execute if data storage minecraft:runechant_crafting_brewer {runechant:{Item:{id:"minecraft:dragon_breath",count:1}}} if data storage minecraft:runechant_crafting_brewer1 {runechant:{Item:{id:"minecraft:phantom_membrane",count:64,components:{"minecraft:custom_model_data":19971}}}} run function runechant:crafting/recipes_structure/brewer/bottled_nightmares

execute if data storage minecraft:runechant_crafting_brewer {runechant:{Item:{id:"minecraft:jigsaw",components:{}}}} run function runechant:crafting/recipes_structure/brewer/jigsaw_check

data remove storage minecraft:runechant_crafting_brewer runechant
data remove storage minecraft:runechant_crafting_brewer1 runechant
data remove storage minecraft:runechant_crafting_brewer2 runechant
data remove storage minecraft:runechant_crafting_brewer3 runechant
data remove storage minecraft:runechant_crafting_brewer4 runechant