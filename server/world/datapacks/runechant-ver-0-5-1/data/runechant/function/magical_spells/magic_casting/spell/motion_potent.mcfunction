...
execute store result entity @s Motion[0] double 0.03 run scoreboard players operation @s xSpell -= @p xSpell
execute store result entity @s Motion[1] double 0.03 run scoreboard players operation @s ySpell -= @p ySpell
execute store result entity @s Motion[2] double 0.03 run scoreboard players operation @s zSpell -= @p zSpell
