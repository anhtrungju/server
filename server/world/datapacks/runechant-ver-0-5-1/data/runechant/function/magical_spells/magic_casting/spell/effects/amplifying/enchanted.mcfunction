...
execute at @e[type=minecraft:interaction,tag=AffinitySpellCheck] run tag @p add EnchantedEnergy
...
execute unless entity @s[tag=amplifying_triple] unless entity @s[tag=amplifying_double] run tag @s remove amplifying_enchanted
