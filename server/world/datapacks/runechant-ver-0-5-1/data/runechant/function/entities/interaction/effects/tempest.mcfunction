...
execute if score @s Erupt matches 1.. run particle minecraft:dust_plume ~ ~0.5 ~ 0.1 0.5 0.1 0.1 2
execute if score @s Erupt matches 100..200 run particle minecraft:shriek{delay:1} ~ ~-0.2 ~ 0.1 0.1 0.1 1 5
execute if score @s Erupt matches 100.. run particle minecraft:dust_plume ~ ~0.5 ~ 0.1 0.5 0.1 0.1 4
execute if score @s Erupt matches 100.. run particle minecraft:shriek{delay:1} ~ ~-0.2 ~ 0.1 0.1 0.1 1 15
execute if score @s Erupt matches 200.. run particle minecraft:shriek{delay:1} ~ ~0.3 ~ 0.1 0.1 0.1 1 10
execute if score @s Erupt matches 200.. run particle minecraft:shriek{delay:1} ~ ~0.8 ~ 0.1 0.1 0.1 1 5
execute if score @s Erupt matches 200.. run particle minecraft:dust_plume ~ ~0.5 ~ 0.1 0.5 0.1 0.1 6
...
execute if score @s Erupt matches 100..200 as @e[type=#runechant:all,distance=..1.1] run damage @s 2 runechant:gale 
execute if score @s Erupt matches 200..500 run effect give @e[type=#runechant:all,distance=..1.1] minecraft:levitation 1 4 true
execute if score @s Erupt matches 200..500 as @e[type=#runechant:all,distance=..1.1] run damage @s 4 runechant:gale 
