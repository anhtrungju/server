...
execute if score @s Erupt matches 60 run summon minecraft:item_display ~ ~0.5 ~ {item:{id:"minecraft:bell",count:1,components:{"minecraft:custom_model_data":199726}}}
execute if score @s Erupt matches 60 run particle minecraft:fishing ~ ~0.5 ~ 0.3 0.3 0.3 0.1 50
execute if score @s Erupt matches 60 run playsound minecraft:item.bone_meal.use weather @a ~ ~0.5 ~

execute if score @s Erupt matches 60.. run particle minecraft:fishing ~ ~0.5 ~ 0.3 0.3 0.3 0.01 1

execute if score @s Erupt matches 60.. run effect clear @e[type=#runechant:all,distance=..2]
execute if score @s Erupt matches 60.. run effect give @e[type=#runechant:all,distance=..2] minecraft:absorption 60 1
execute if score @s Erupt matches 60.. run effect give @e[type=#runechant:all,distance=..2] minecraft:resistance 60 1
