...
execute if score @s Erupt matches 100..200 run particle minecraft:portal ~ ~ ~ 0.1 0.1 0.1 1 3
execute if score @s Erupt matches 100..200 run particle minecraft:soul ~ ~ ~ 0.3 0 0.3 0.01 3
execute if score @s Erupt matches 100..200 run tp @e[type=#runechant:all,distance=..1.1] ~ ~ ~

execute if score @s Erupt matches 200.. run kill @s

execute if score @s Erupt matches 100 run summon minecraft:marker ~1 ~ ~ {Tags:["Season","SoulTether"]}
execute if score @s Erupt matches 100 run summon minecraft:marker ~ ~ ~1 {Tags:["Season","SoulTether"]}
execute if score @s Erupt matches 100 run summon minecraft:marker ~-1 ~ ~ {Tags:["Season","SoulTether"]}
execute if score @s Erupt matches 100 run summon minecraft:marker ~ ~ ~-1 {Tags:["Season","SoulTether"]}

execute if score @s Erupt matches 160 run summon minecraft:marker ~2 ~ ~ {Tags:["Season","SoulTether"]}
execute if score @s Erupt matches 160 run summon minecraft:marker ~ ~ ~2 {Tags:["Season","SoulTether"]}
execute if score @s Erupt matches 160 run summon minecraft:marker ~-2 ~ ~ {Tags:["Season","SoulTether"]}
execute if score @s Erupt matches 160 run summon minecraft:marker ~ ~ ~-2 {Tags:["Season","SoulTether"]}
execute if score @s Erupt matches 160 run summon minecraft:marker ~1 ~ ~1 {Tags:["Season","SoulTether"]}
execute if score @s Erupt matches 160 run summon minecraft:marker ~1 ~ ~-1 {Tags:["Season","SoulTether"]}
execute if score @s Erupt matches 160 run summon minecraft:marker ~-1 ~ ~-1 {Tags:["Season","SoulTether"]}
execute if score @s Erupt matches 160 run summon minecraft:marker ~-1 ~ ~1 {Tags:["Season","SoulTether"]}