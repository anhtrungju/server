...
execute if entity @s[tag=!Grown] positioned ~1 ~ ~ if block ~ ~ ~ #runechant:non_solid unless entity @e[type=minecraft:marker,tag=FlamePillarX,distance=..0.5] if entity @p[distance=..32] run summon minecraft:marker ~ ~ ~ {Tags:["Season","FlamePillarX"]}
execute if entity @s[tag=!Grown] positioned ~-1 ~ ~ if block ~ ~ ~ #runechant:non_solid unless entity @e[type=minecraft:marker,tag=FlamePillarX,distance=..0.5] if entity @p[distance=..32] run summon minecraft:marker ~ ~ ~ {Tags:["Season","FlamePillarX"]} 
...
execute if score @s Erupt matches 1..60 run particle minecraft:smoke ~ ~ ~ 0.5 0.1 0.1 0.01 1
...
execute if score @s Erupt matches 60.. run particle minecraft:flame ~ ~ ~ 0.5 0.1 0.1 0.02 1
...
execute if score @s Erupt matches 120.. run particle minecraft:flame ~ ~ ~ 0.5 0.2 0.2 0.02 2
...
execute if score @s Erupt matches 180..240 run particle minecraft:flame ~ ~ ~ 0.5 0.3 0.3 0.02 3
...
execute if score @s Erupt matches 240.. run scoreboard players set @e[type=minecraft:marker,tag=FlamePillarX,distance=..3] Erupt 241
