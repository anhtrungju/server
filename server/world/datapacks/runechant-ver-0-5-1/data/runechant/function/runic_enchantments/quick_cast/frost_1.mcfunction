...
execute positioned ^ ^ ^3 as @e[type=#runechant:all,distance=..2.99,limit=1] run tag @s[tag=Frostbite1] add Frostbite2
execute positioned ^ ^ ^3 as @e[type=#runechant:all,distance=..2.99,limit=1] run tag @s add Frostbite1
