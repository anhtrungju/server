...
execute positioned ^ ^ ^3 as @e[type=#runechant:all,distance=..2.99,limit=1] run tag @s[tag=Scorched1] add Scorched2
execute positioned ^ ^ ^3 as @e[type=#runechant:all,distance=..2.99,limit=1] run tag @s add Scorched1
