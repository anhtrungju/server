...
execute if data storage minecraft:runechant_frame {runechant:{Item:{id:"minecraft:paper",components:{"minecraft:lore":['{"bold":false,"color":"white","italic":false,"text":"Bind"}']}}}} run data remove entity @e[limit=1,type=minecraft:item_frame,sort=nearest] Item.id 
...
execute if data storage minecraft:runechant_frame {runechant:{Item:{id:"minecraft:paper",components:{"minecraft:lore":['{"bold":false,"color":"white","italic":false,"text":"Blind"}']}}}} run data remove entity @e[limit=1,type=minecraft:item_frame,sort=nearest] Item.id 
...
execute if data storage minecraft:runechant_frame {runechant:{Item:{id:"minecraft:paper",components:{"minecraft:lore":['{"bold":false,"color":"white","italic":false,"text":"Conjure"}']}}}} run data remove entity @e[limit=1,type=minecraft:item_frame,sort=nearest] Item.id 
...
execute if data storage minecraft:runechant_frame {runechant:{Item:{id:"minecraft:paper",components:{"minecraft:lore":['{"bold":false,"color":"white","italic":false,"text":"Defend"}']}}}} run data remove entity @e[limit=1,type=minecraft:item_frame,sort=nearest] Item.id 
...
execute if data storage minecraft:runechant_frame {runechant:{Item:{id:"minecraft:paper",components:{"minecraft:lore":['{"bold":false,"color":"white","italic":false,"text":"Doom"}']}}}} run data remove entity @e[limit=1,type=minecraft:item_frame,sort=nearest] Item.id 
...
execute if data storage minecraft:runechant_frame {runechant:{Item:{id:"minecraft:paper",components:{"minecraft:lore":['{"bold":false,"color":"white","italic":false,"text":"Warp"}','{"bold":false,"color":"green","italic":false,"text":"Lesser Rune"}']}}}} if entity @e[type=minecraft:item_frame,nbt={Item:{id:"minecraft:paper",components:{"minecraft:lore":['{"bold":false,"color":"white","italic":false,"text":"Warp"}','{"bold":false,"color":"green","italic":false,"text":"Lesser Rune"}']}}},sort=nearest,distance=1..,limit=1] if entity @e[distance=..0.5,type=#runechant:all_with_projectiles,tag=!Teleported] run tag @e[limit=1,type=minecraft:item_frame,sort=nearest] add ClearItem
execute if data storage minecraft:runechant_frame {runechant:{Item:{id:"minecraft:paper",components:{"minecraft:lore":['{"bold":false,"color":"white","italic":false,"text":"Warp"}','{"bold":false,"color":"green","italic":false,"text":"Lesser Rune"}']}}}} run tag @e[distance=..0.5,type=#runechant:all_with_projectiles,tag=!Teleported] add Teleported
execute if data storage minecraft:runechant_frame {runechant:{Item:{id:"minecraft:paper",components:{"minecraft:lore":['{"bold":false,"color":"white","italic":false,"text":"Warp"}','{"bold":false,"color":"green","italic":false,"text":"Lesser Rune"}']}}}} if entity @s[tag=ClearItem] if entity @e[distance=..0.5,type=#runechant:all_with_projectiles,tag=Teleported] as @e[distance=..0.5,type=#runechant:all_with_projectiles,limit=1,sort=nearest] at @e[type=minecraft:item_frame,nbt={Item:{id:"minecraft:paper",components:{"minecraft:lore":['{"bold":false,"color":"white","italic":false,"text":"Warp"}','{"bold":false,"color":"green","italic":false,"text":"Lesser Rune"}']}}},sort=nearest,distance=1..,limit=1] run tp @s ~ ~ ~ 
