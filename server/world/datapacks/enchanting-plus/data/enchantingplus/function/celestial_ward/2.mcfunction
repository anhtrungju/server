...
execute at @e[tag=enchantingplus.celestial_ward.marker.centre] run tp @e[tag=enchantingplus.celestial_ward.marker.1] ^3 ^ ^
execute at @e[tag=enchantingplus.celestial_ward.marker.centre] run tp @e[tag=enchantingplus.celestial_ward.marker.2] ^-1.5 ^ ^2.598
execute at @e[tag=enchantingplus.celestial_ward.marker.centre] run tp @e[tag=enchantingplus.celestial_ward.marker.3] ^-1.5 ^ ^-2.598
...
execute at @s as @e[distance=..3,tag=!enchantingplus.celestial_ward.equip.2,type=#enchantingplus:aggressive] run damage @s 2 indirect_magic by @n[tag=enchantingplus.celestial_ward.equip.2,distance=..3]