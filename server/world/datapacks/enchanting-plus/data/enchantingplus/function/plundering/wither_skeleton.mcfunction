advancement revoke @s only enchantingplus:technical/plundering/wither_skeleton
...
execute as @s[tag=enchantingplus.plundering.looting.1] run loot give @p loot enchantingplus:plundering/wither_skeleton/looting_1
execute as @s[tag=enchantingplus.plundering.looting.2] run loot give @p loot enchantingplus:plundering/wither_skeleton/looting_2
execute as @s[tag=enchantingplus.plundering.looting.3] run loot give @p loot enchantingplus:plundering/wither_skeleton/looting_3
execute as @s[tag=enchantingplus.plundering.beheading.1] run loot give @p loot enchantingplus:plundering/wither_skeleton/beheading_1
execute as @s[tag=enchantingplus.plundering.beheading.2] run loot give @p loot enchantingplus:plundering/wither_skeleton/beheading_2
execute as @s[tag=enchantingplus.plundering.beheading.3] run loot give @p loot enchantingplus:plundering/wither_skeleton/beheading_3
execute as @s[tag=enchantingplus.plundering.nothing.] run loot give @p loot minecraft:entities/wither_skeleton
