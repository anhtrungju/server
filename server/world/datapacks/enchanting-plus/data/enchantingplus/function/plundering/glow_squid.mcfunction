advancement revoke @s only enchantingplus:technical/plundering/glow_squid
...
execute if entity @s[tag=enchantingplus.plundering.nothing] run loot give @p loot enchantingplus:plundering/glow_squid/plain
execute if entity @s[tag=enchantingplus.plundering.looting.1] run loot give @p loot enchantingplus:plundering/glow_squid/looting_1
execute if entity @s[tag=enchantingplus.plundering.looting.2] run loot give @p loot enchantingplus:plundering/glow_squid/looting_2
execute if entity @s[tag=enchantingplus.plundering.looting.3] run loot give @p loot enchantingplus:plundering/glow_squid/looting_3
