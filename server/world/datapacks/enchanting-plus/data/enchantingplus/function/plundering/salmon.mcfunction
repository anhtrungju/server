advancement revoke @s only enchantingplus:technical/plundering/salmon
...
execute if entity @s[tag=enchantingplus.plundering.nothing] run loot give @p loot minecraft:entities/salmon
execute if entity @s[tag=enchantingplus.plundering.fire] run loot give @p loot enchantingplus:plundering/salmon/fire
