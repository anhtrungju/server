advancement revoke @s only enchantingplus:technical/plundering/piglin
...
execute if entity @s[tag=enchantingplus.plundering.beheading] run loot give @p loot enchantingplus:plundering/piglin/beheading
