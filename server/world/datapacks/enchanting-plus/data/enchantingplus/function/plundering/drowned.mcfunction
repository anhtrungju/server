advancement revoke @s only enchantingplus:technical/plundering/drowned
...
execute if entity @s[tag=enchantingplus.plundering.nothing] run loot give @p loot enchantingplus:plundering/drowned/plain
execute if entity @s[tag=enchantingplus.plundering.looting.1] run loot give @p loot enchantingplus:plundering/drowned/looting_1
execute if entity @s[tag=enchantingplus.plundering.looting.2] run loot give @p loot enchantingplus:plundering/drowned/looting_2
execute if entity @s[tag=enchantingplus.plundering.looting.3] run loot give @p loot enchantingplus:plundering/drowned/looting_3
